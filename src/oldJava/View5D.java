  ...
  /* The code below is necessary to include the software as a plugin into Matlab and DipImage (Univ. Delft) */
   ...
   /* Just an alias to call the overloaded methods from Python using pyjnius */
    public static View5D Start5DViewerB(byte [] array, int SizeX, int SizeY, int SizeZ,int Elements,int Times) {
       return Start5DViewer(array,SizeX,SizeY,SizeZ,Elements,Times);
    }
   ...
   public static View5D Start5DViewer(short [] sarray, int SizeX, int SizeY, int SizeZ,int Elements,int Times) {
    ...
    /* The code below is necessary to include the software as a plugin into Matlab and DipImage (Univ. Delft) */
    public static View5D Start5DViewer(unsigned short [] sarray, int SizeX, int SizeY, int SizeZ,int Elements,int Times) {
        int DataType=AnElement.ShortType, NumBytes=2, NumBits=16;
    ...
    /* Just an alias to call the overloaded methods from Python using pyjnius */
    public static View5D Start5DViewerUS(unsigned2 short [] array, int SizeX, int SizeY, int SizeZ,int Elements,int Times) {
        return Start5DViewer(array,SizeX,SizeY,SizeZ,Elements,Times);
    }
